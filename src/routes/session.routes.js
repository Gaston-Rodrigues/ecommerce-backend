...
import { createUser, deleteUser, getUserById, getUsers, loginUser, logout,getGoogle, handleGoogleLogin} from "../controller/session.controller.js";
...
sessionRoutes.post('/auth/google', handleGoogleLogin);
